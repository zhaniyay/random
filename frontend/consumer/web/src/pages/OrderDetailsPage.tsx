...
import { Package, Send, X, AlertCircle, Image as ImageIcon, Paperclip, Mic, Download, FileText } from 'lucide-react';
...
const OrderDetailsPage = () => {
  ...
  const handleCancelOrder = () => {
    if (window.confirm('Are you sure you want to cancel this order?')) {
      cancelOrderMutation.mutate(parseInt(orderId!));
    }
  };
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '1rem', color: '#6b7280' }}>
            Supplier #{order.supplier_id} • Created {new Date(order.created_at).toLocaleDateString()}
          </p>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Communicate with the supplier about this order
              </p>
            </div>
